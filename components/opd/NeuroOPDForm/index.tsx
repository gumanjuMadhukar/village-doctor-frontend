...
const NeuroOPDForm = (validData:OPDDepFormCheck) => {
  
  const {dob, gender, selectedOption} = validData
  const age = calculateAge(dob);
  const isNeuroPatient=true; 
  return (
    <>
      ...
      <Col span={24} className="main-div">
        <PersonalHistoryForm dob={dob} selectedOption={selectedOption} />
      </Col>
      ...
      <Col span={24} className="main-div">
        {/* <Card title="Examination / परीक्षण" className="mt-10" size="small">
          <Row>
            ...
            <Col span={24}>
              <SystemicExaminationForm isNeuroPatient={true} isPsychiatryPatient={false} />
            </Col>
          </Row>
        </Card> */}
        <Examination props={{dob, isNeuroPatient}}/>
      </Col>
      <Col span={24} className="main-div">
